...
public class RqlitePreparedStatement implements PreparedStatement {
    private RqliteConnection conn;

    private String stmt_sql = null;
    private QueryResults queryResults = null;
    private RqliteResultSet select_result = null;
    private ExecuteResults update_result = null;
    private boolean is_update = false;
    private Object[] params = new Object[0];
    private RqliteResultSetMetaData meta = null;

    public RqlitePreparedStatement(RqliteConnection conn) throws SQLException {
        if (conn == null) {
    ...
    public RqlitePreparedStatement(RqliteConnection conn, String sql) throws SQLException {
        if (conn == null) {
            throw new SQLException("connection parameter cannot be null");
        }
        if (sql == null) {
    ...
    public boolean execute() throws SQLException {
        ...
        if (is_update) {
            ...
            meta = new RqliteResultSetMetaData(
                    ...
                    queryResults.results[0].columns,
                    queryResults.results[0].types
            );
    ...
    public int executeUpdate() throws SQLException {
        ...
        execute();
        return update_result.results[0].rowsAffected;
    }
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        ...
        if (stmt_sql == null || select_result == null) {
    ...
    public int getUpdateCount() throws SQLException {
        ...
        if (!is_update || update_result == null) {
            return -1;
        }
        return update_result.results[0].rowsAffected;
    }
